...
class TrivialCorpusFilterTextFileWriter(CorpusFilterTextFileWriter[str]):
    """docstring for TrivialCorpusFilterTextFileWriter"""
    def __init__(self, f_in_path: str, f_accept_out_path: str, f_reject_out_path: Optional[str] = None):
        super().__init__(f_accept_out_path, f_reject_out_path)
        self._f_in = open(f_in_path, 'r')
...
class NModFilteredCorpus(PickleStanzaDocCorpusFilterWriter):
...
if __name__ == '__main__':
    ...
    f_accept_out_path = sys.argv[2]
    f_reject_out_path = sys.argv[3]
    print('args:', f_in_path, f_accept_out_path, f_reject_out_path)

    with TrivialCorpusFilterTextFileWriter(f_in_path, f_accept_out_path, f_reject_out_path) as trivialFilter:
        print('in the with block')
        trivialFilter.filter_write()
